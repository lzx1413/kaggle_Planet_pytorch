...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/mnt/lvm/zuoxin/kaggle/Planet/', type=str, metavar='PATH',
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        test_loss = test(val_loader, model, criterion, epoch, use_cuda)
